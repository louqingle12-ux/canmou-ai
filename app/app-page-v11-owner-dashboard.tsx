  ...
  return <main className="app">
    ...
    <section className="content">
      ...
      <section className="panel" id="owner-dashboard" style={{marginTop:18}}>
        ...
        <div style={{padding:16,border:"1px solid #e1ebe6",borderRadius:14,background:"#f9fbfa"}} style={{marginTop:16}}><div style={{fontSize:12,color:"#71847b",marginBottom:7,display:"block"}}>🎯 今天就做这3件事</div><div style={{display:"grid",gap:8,marginTop:10}}>{dashboardActions.map((a,i)=><div key={i} style={{display:"flex",gap:10,alignItems:"center",fontSize:14}}><span style={{width:24,height:24,borderRadius:8,background:"#eaf3ee",display:"grid",placeItems:"center",fontWeight:800}}>{i+1}</span><span>{a}</span></div>)}</div></div>
      </section>
